...
export const helpers: Helper[] = [
  {
    id: 'yugwansun',
    name: '유관순',
    avatar: '/assets/characters/yugwansun.png',
    trait: '용기·직관',
  ...
  },
  {
    id: 'ahnjunggeun',
    name: '안중근',
    avatar: '/assets/characters/ahnjunggeun.png',
    trait: '정의·결단',
  ...
  },
  {
    id: 'yunbonggil',
    name: '윤봉길',
    avatar: '/assets/characters/yunbonggil.png',
    trait: '희생·열정',
  ...
  },
  {
    id: 'kimgu',
    name: '김구',
    avatar: '/assets/characters/kimgu.png',
    trait: '신중·지혜',
